			...
			<form action="createorderadminservlet" method="post">
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="order_id"
						name="order_id" placeholder="Order ID" required />
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					<label for="total" class="form-label">Total Cost</label> <input
						type="text" class="form-control" id="total" name="total"
						placeholder="Total Cost" required />
				</div>
				<div class="mb-3">
					<label for="payment" class="form-label">Payment Status</label> <select
						class="form-select" id="payment" name="payment">
