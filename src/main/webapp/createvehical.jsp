        ...
        <div class="content">
          ...
          <div class="form-container">
            <form action="createorderadminservlet" method="post">
              <div class="mb-3">
                <label for="Vehical Type" class="form-label">Vehical Type</label>
                <input type="text" class="form-control" id="Vehical Type" name="VehicalType" placeholder="Vehical Type"
                  required />
              </div>

              <div class="mb-3">
                <label for="Capacity" class="form-label">Capacity</label> <input type="text" class="form-control"
                  id="Capacity" name="capacity" placeholder="Capacity" required />
              </div>

              <div class="mb-3">
                <label for="numberPlate" class="form-label">NumberPlate</label> <input type="text" class="form-control"
                  id="numberPlate" name="numberPlate" placeholder="numberPlate" required />
              </div>
