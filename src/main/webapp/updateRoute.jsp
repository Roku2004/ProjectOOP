          ...
          <div class="form-container">
            <form action="updateRouteservlet" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Route id" name="route_id" placeholder="Route id"
                  required />
              </div>

              <div class="mb-3">
                <label for="Start Point" class="form-label">Start Point</label>
                <input type="text" class="form-control" id="Start Point" name="startpoint" placeholder="Start Point"
                  required />
              </div>

              <div class="mb-3">
                <label for="End Point" class="form-label">End Point</label> <input type="text" class="form-control"
                  id="End Point" name="endpoint" placeholder="End Point" required />
              </div>
              ...
              <div class="mb-3">
                <label for="Vehical" class="form-label">Vehical</label> <input type="text" class="form-control"
                  id="Vehical" name="vehical" placeholder="Vehical" required />
              </div>
